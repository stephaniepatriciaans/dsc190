...
# Output files
PORTS_CLEAN_FILE = PROCESSED_DIR / "ports_clean.csv"
POP_CLEAN_FILE = PROCESSED_DIR / "population_states.csv"
GAS_CLEAN_FILE = PROCESSED_DIR / "gas_prices_clean.csv"
EV_REG_CLEAN_FILE = PROCESSED_DIR / "ev_registrations_clean.csv"
